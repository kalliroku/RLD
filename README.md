...
| M5 | 한영 i18n ✅ (418키) + 출시 페이지 ✅ + BGM 4트랙 ✅ (D-2026-05-21-1) → 플레이테스트 → 1.0 | ⏳ 진행 중 |
...
1. **M5 → 1.0 (현재)**: 자체 플레이테스트 5회 + BGM 시청 검증 + narrative 사이클 (W7.2/W7.4/W7.5). i18n 마감 ✅ (418키, D-2026-05-15-16 4/4 완전 closure) + 출시 페이지 ✅ + BGM 4트랙 ✅ (Web Audio raw 절차적 합성, D-2026-05-21-1)
