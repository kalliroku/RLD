...
**Last updated**: 2026-05-15 (M5 — 출시 페이지 1차 + B-208.2 itch.io 카피 초안 박제)
...
- **M5 진입** — **B-207 silent_q placeholder ✅** + **한영 i18n 2차 ✅** + **B-208 출시 페이지 1차 ✅** + **B-208.2 itch.io 카피 초안 ✅** (사용자 검수 대기). 다음 항목: 스크린샷 4~6장 (B-208.1) / github pages 활성화 (B-208.3, admin) / BGM 4트랙 (사용자 결정 후) / 자체 플레이테스트 5회 (1.0 게이트).
