...
export class Grid {
    constructor(width, height) {
        ...
        this.startPos = null;
        this.goalPos = null;
        this.slippery = false; // FrozenLake-style stochastic transitions
...
###########`,
    ...
    // Level 26: Frozen Lake - 미끄러운 바닥 (확률적 전이)
    // Expected SARSA / Double Q-Learning 쇼케이스
    // FrozenLake 스타일: 1/3 의도, 1/3 왼쪽, 1/3 오른쪽으로 미끄러짐
...
###########`,
    ...
    // Level 27: Ice Maze - 미끄러운 바닥 + 미로
    // 확률적 전이에서 벽이 안전장치가 되는 환경
    level_27_ice_maze: `#############
#S..#.......#
#.#.#.#####.#
#.#...#...#.#
...
#############`,
    ...
    // Level 28: Frozen Cliff - 미끄러운 절벽
    // SARSA: 안전 경로, Q-Learning: 절벽 추락, Expected SARSA: 안정적 학습
...
##################`,
    ...
    // Level 29: Big Maze - 25×25 대규모 미로
    // tabular 알고리즘 스케일링 테스트
    level_29_big_maze: `###########################
#S..#.......#.............#
#.#.#.#####.#.###########.#
#.#...#...#.#.#...........#
