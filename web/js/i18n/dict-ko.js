...
export const KO = {
    ...
    'onboard.b1': '{master}, 일어나셨군요. 좋은 점심입니다.',
    'onboard.b2': '…왜 하필 나한테 이 자리가 떨어진 걸까.',
    'onboard.b3': '첫 출근이시니 딱 하나만 일러둘게요. 이게 길드 자금, G예요.',
    'onboard.b4': '던전에 들 땐 이 G로 식량을 채워 출발해요. 도중에 떨어지면… 상상도 하기 싫네요.',
    'onboard.b5': '대신 던전을 답파하면 큰 돈이 들어와요. 넉넉해지면 좋은 것들도 들일 수 있고요.',
    'onboard.b6': '그러니 바닥내지 말고… 우리 같이 이 길드를 키워봐요!',
    'onboard.b7': "'같이'라니. 떠맡은 건 난데 말이지.",
    'onboard.b8': '{master}! 마침 잘 계셨어요. 모험가 길드에서 의뢰가 내려왔어요.',
    'onboard.b9': '첫 의뢰예요. 방금 게시판에 붙여 뒀어요!',
    'onboard.b10': '저기 의뢰서, 한번 확인해 보죠.',
