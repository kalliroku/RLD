...
export const EN = {
    ...
    'guild.tab.shop': 'Shop',
    'guild.tab.map': 'Map',
    // Signboard progress — chapter + cumulative clears instead of Run# ({master} → 'Master')
    'guild.signboard': 'Ch.{ch} {name} · {k} cleared',
    ...
    'onboard.b1': "{master}, you're up. Good afternoon.",
    'onboard.b2': '…Why did this post have to land on me, of all people.',
    'onboard.b3': "It's your first day, so just one thing. This is the guild's money — G.",
    'onboard.b4': "You stock up on provisions with G before a dungeon. Run out partway and… I'd rather not imagine it.",
    'onboard.b5': 'Clear a dungeon, though, and the money pours in. With enough, we can bring in nice things too.',
    'onboard.b6': "So don't run it dry… let's grow this guild together!",
    'onboard.b7': '"Together," she says. I\'m the one stuck with it.',
    'onboard.b8': "{master}! Good, you're here. A request came down from the Adventurers' Guild.",
    'onboard.b9': 'Your first request. I just pinned it to the board!',
    'onboard.b10': "Let's take a look at that request, shall we?",

    // === Mission board / cards ===
    'mission.badge.new': 'NEW',
    'mission.badge.clear': 'CLEAR',
    'mission.badge.farming': 'Farming',
    'mission.badge.boss': 'BOSS',
    'mission.boss_sep': 'Boss',
    'mission.board.more': 'More requests unlock as you clear.',
    'mission.board.boss_locked': 'Unlocks when every request in this chapter is cleared.',
    'mission.reward.first': 'Reward +{n}G',
    'mission.reward.farm': 'Farming reward +{n}G',
    'mission.farming_lock': '🔒 {name} · 100% cleared',

    // === Prep room ===
    'prep.title': 'Prep Room — Lv.{lv} {name}',
    'prep.difficulty': 'Difficulty {stars}',
    'prep.cleared': 'Cleared',
    'prep.best': 'Best {n} steps',
    'prep.uncleared': 'Not cleared',
    'prep.reward.first': 'First clear +{n}G',
    ...
    'flavor.ice': 'The ground is slippery underfoot.',
    'flavor.trap': 'The floor looks rigged.',
    'flavor.maze': 'The paths twist in on themselves.',
    'flavor.pit': 'Deep pits yawn open.',
    'flavor.danger': 'One wrong step could be fatal.',
    'flavor.gauntlet': 'Trials wait in a row.',
    'flavor.cliff': 'The footing is precarious.',
    'flavor.hall': 'A corridor with no end in sight.',
    'flavor.field': 'Open ground stretches all around.',
    'flavor.paths': 'The path forks in two.',
    'flavor.dead_end': 'Dead ends hide everywhere.',
    'flavor.bridge': 'A narrow bridge must be crossed.',
    'flavor.cave': 'Deep darkness pools here.',
    'flavor.default': 'Nothing remarkable, by the look of it.',
